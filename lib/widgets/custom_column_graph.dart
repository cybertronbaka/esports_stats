...
class CustomColumnGraph extends StatefulWidget{
  final ColumnChartSchema schema;

  const CustomColumnGraph({
    Key? key,
    required this.schema
  }) : super(key: key);

  @override
  State<StatefulWidget> createState() => _CustomColumnGraphState();
}

class _CustomColumnGraphState extends State<CustomColumnGraph>{
